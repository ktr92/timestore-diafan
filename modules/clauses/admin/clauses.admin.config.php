	...
	public $variables = array (
		'config' => array (
			...
			'nastr' => array(
				...
				'help' => 'Количество одновременно выводимых статей в списке.',
			),
			'show_more' => array(
				'type' => 'checkbox',
				'name' => 'Включить «Показать ещё»',
				'help' => 'На странице статей появится кнопка «Показать ещё». Увеличивает количество одновременно выводимых статей в списке.',
			),
			'format_date' => array(
				'type' => 'select',
				'name' => 'Формат даты',
            ...
            'first_page_list' => array(
				'type' => 'checkbox',
				'name' => 'Выводить на первой странице весь список статей',
				'help' => 'По умолчанию на первой странице выводится список категорий с несколькими статьями.',
				'depend' => 'cat',
			),	
			'cat' => array(
				'type' => 'checkbox',
				'name' => 'Использовать категории',
				'help' => 'Позволяет включить/отключить категории статей.',
			),
			'count_list' => array(
				'type' => 'numtext',
				'name' => 'Количество статей в списке категорий',
				'help' => 'Количество статей, выводимых в списке категорий на главной странице модуля.',
				'depend' => 'cat',
			),
			'nastr_cat' => array(
				'type' => 'numtext',
			...
			'children_elements' => array(
				...
				'help' => 'Если отмечена, в списке статей категории будут отображатся статьи из всех вложенных категорий.',
				'depend' => 'cat',
			),
			'hr3' => array(
				'type' => 'title',
			...
			'images_element' => array(
				...
				'help' => 'Позволяет включить/отключить загрузку изображений к статьям.',
				'no_save' => true,
			),
			'images_variations_element' => array(
				'type' => 'none',
				'name' => 'Генерировать размеры изображений',
				'help' => 'Размеры изображений, заданные в модуле «Изображения» и тег латинскими буквами для подключения изображения на сайте. Обязательно должны быть заданы два размера: превью изображения в списке статей (тег medium) и полное изображение (тег large).',
				'no_save' => true,
			),
			...
			'counter' => array(
				...
				'help' => 'Позволяет считать количество просмотров отдельной статьи.',
			),
			'counter_site' => array(
				'type' => 'checkbox',
				'name' => 'Выводить счетчик на сайте',
				'help' => 'Позволяет вывести на сайте количество просмотров отдельной статьи. Параметр выводится, если отмечена опция «Счетчик просмотров».',
				'depend' => 'counter',
			),
			'comments' => array(
				'type' => 'module',
				'name' => 'Подключить комментарии к статьям',
			...
			'comments_cat' => array(
				...
				'help' => 'Подключение модуля «Комментарии» к категориям статей. Параметр не будет включен, если модуль «Комментарии» не установлен. Подробности см. в разделе [модуль «Комментарии»](http://www.diafan.ru/dokument/full-manual/upmodules/comments/).',
				'no_save' => true,
			),
			'tags' => array(
				'type' => 'module',
			...
			'rating' => array(
				'type' => 'module',
				'name' => 'Подключить рейтинг статей',
			...
			'rel_two_sided' => array(
				...
				'help' => 'Если отметить, то при назначении статье А похожей статьи Б, у статьи Б автоматически станет похожая статья А.',
			),
			'hr5' => array(
				'type' => 'title',
			...
			'title_tpl' => array(
				...
				'help' => "Если шаблон задан и для статьи не прописан заголовок *Title*, то заголовок автоматически генерируется по шаблону. В шаблон можно добавить:\n\n* %name – название,\n* %category – название категории,\n* %parent_category – название категории верхнего уровня (SEO-специалисту).",
				'multilang' => true
			),
			'title_tpl_cat' => array(
				'type' => 'text',
			...
			'keywords_tpl' => array(
				...
				'help' => "Если шаблон задан и для статьи не заполнено поле *Keywords*, то поле *Keywords* автоматически генерируется по шаблону. В шаблон можно добавить:\n\n* %name – название,\n* %category – название категории,\n* %parent_category – название категории верхнего уровня (SEO-специалисту).",
				'multilang' => true
			),
			...
			'descr_tpl' => array(
				...
				'help' => "Если шаблон задан и для статьи не заполнено поле *Description*, то поле *Description* автоматически генерируется по шаблону. В шаблон можно добавить:\n\n* %name – название,\n* %category – название категории,\n* %parent_category – название категории верхнего уровня,\n* %anons – краткое описание (SEO-специалисту).",
				'multilang' => true
			),
			'descr_tpl_cat' => array(
				'type' => 'text',
			...
			'theme_list' => array(
				...
				'help' => 'По умолчанию modules/clauses/views/clauses.view.list.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате.',
			),
			'view_list' => array(
				'type' => 'none',
				'hide' => true,
			...
			'theme_list_rows' => array(
				...
				'help' => 'По умолчанию modules/clauses/views/clauses.view.rows.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате. Значение параметра важно для AJAX.',
			),
			...
			'theme_first_page' => array(
				...
				'help' => 'По умолчанию modules/clauses/views/clauses.view.fitst_page.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате.',
			),
			...
			'theme_id' => array(
				...
				'help' => 'По умолчанию, modules/clauses/views/clauses.view.id.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате.',
			),
			'view_id' => array(
				'type' => 'none',
				'hide' => true,
