...
/**
 * Clauses_admin_category
 */
class Clauses_admin_category extends Frame_admin
{
    /**
     * @var string таблица в базе данных
     */
    public $table = 'clauses_category';
	...
	public $variables = array (
		...
		'other_rows' => array (
			...
			'view' => array(
				'type' => 'function',
				'name' => 'Шаблон модуля',
				'help' => 'Шаблон вывода контента модуля на странице списка статей в категории (веб-мастеру и программисту, не меняйте этот параметр, если не уверены в результате!).',
			),
			'view_rows' => array(
				'type' => 'function',
			...
			'view_element' => array(
				...
				'help' => 'Шаблон вывода контента модуля на странице отдельной статьи, вложенной в текущую категорию (веб-мастеру и программисту, не меняйте этот параметр, если не уверены в результате!).',
			),			
		),
	);
