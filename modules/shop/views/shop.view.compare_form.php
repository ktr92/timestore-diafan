...
<img src="/images/repeat.png" alt="">&nbsp;<label class="shop_add_compare add_compare 
colored '.($checked ? 'active' : '').'" for="id_add'.$result["id"].'">'.$this->diafan->_('Добавить к сравнению', false).'</label>
</form>';