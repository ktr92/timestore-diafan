	...
	public $variables = array (
		'config' => array (
			...
			'nastr' => array(
				...
				'help' => 'Количество одновременно выводимых файлов в списке.',
			),
			'show_more' => array(
				'type' => 'checkbox',
				'name' => 'Включить «Показать ещё»',
				'help' => 'На странице файлов появится кнопка «Показать ещё». Увеличивает количество одновременно выводимых файлов в списке.',
			),
			...
			'cat' => array(
				...
				'help' => 'Позволяет включить/отключить категории файлов.',
			),
			'nastr_cat' => array(
				'type' => 'numtext',
			...
			'count_list' => array(
				...
				'help' => 'Количество файлов, выводимых в списке категорий на главной странице модуля.',
				'depend' => 'cat',
			),
			...
			'children_elements' => array(
				...
				'help' => 'Если отмечена, в списке файлов категории будут отображатся файлы из всех вложенных категорий.',
				'depend' => 'cat',
			),
			'hr3' => array(
				'type' => 'title',
			...
			'images_element' => array(
				...
				'help' => 'Позволяет включить/отключить загрузку изображений к файлам.',
				'no_save' => true,
			),
			...
			'counter' => array(
				...
				'help' => 'Позволяет считать количество просмотров отдельного файла.',
			),
			'counter_site' => array(
				'type' => 'checkbox',
				'name' => 'Выводить счетчик на сайте',
				'help' => 'Позволяет вывести на сайте количество просмотров отдельного файла. Параметр выводится, если отмечена опция «Счетчик просмотров».',
				'depend' => 'counter',
			),
			'comments' => array(
				'type' => 'module',
			...
			'comments_cat' => array(
				...
				'help' => 'Подключение модуля «Комментарии» к категориям файлов. Параметр не будет включен, если модуль «Комментарии» не установлен. Подробности см. в разделе [модуль «Комментарии»](http://www.diafan.ru/dokument/full-manual/upmodules/comments/).',
				'no_save' => true,
			),
			'tags' => array(
				'type' => 'module',
			...
			'rel_two_sided' => array(
				...
				'help' => 'Позволяет установленную в файле связь с другим файлом использовать в двух направлениях.',
			),
			'hr5' => array(
				'type' => 'title',
			...
			'title_tpl' => array(
				...
				'help' => "Если шаблон задан и для файла не прописан заголовок *Title*, то заголовок автоматически генерируется по шаблону. В шаблон можно добавить:\n\n* %name – название,\n* %category – название категории,\n* %parent_category – название категории верхнего уровня (SEO-специалисту).",
				'multilang' => true
			),
			'title_tpl_cat' => array(
				'type' => 'text',
			...
			'keywords_tpl' => array(
				...
				'help' => "Если шаблон задан и для файла не заполнено поле *Keywords*, то поле *Keywords* автоматически генерируется по шаблону. В шаблон можно добавить:\n\n* %name – название,\n* %category – название категории,\n* %parent_category – название категории верхнего уровня (SEO-специалисту).",
				'multilang' => true
			),
			...
			'descr_tpl' => array(
				...
				'help' => "Если шаблон задан и для файла не заполнено поле *Description*, то поле *Description* автоматически генерируется по шаблону. В шаблон можно добавить:\n\n* %name – название,\n* %category – название категории,\n* %parent_category – название категории верхнего уровня,\n* %anons – краткое описание (SEO-специалисту).",
				'multilang' => true
			),
			'descr_tpl_cat' => array(
				'type' => 'text',
			...
			'theme_list' => array(
				...
				'help' => 'По умолчанию modules/files/views/files.view.list.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате.',
			),
			'view_list' => array(
				'type' => 'none',
				'hide' => true,
			...
			'theme_list_rows' => array(
				...
				'help' => 'По умолчанию modules/files/views/files.view.rows.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате. Значение параметра важно для AJAX.',
			),
			...
			'theme_first_page' => array(
				...
				'help' => 'По умолчанию modules/files/views/files.view.fitst_page.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате.',
			),
			...
			'theme_first_page_rows' => array(
				...
				'help' => 'По умолчанию modules/files/views/files.view.fitst_page.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате. Значение параметра важно для AJAX.',
			),
			...
			'theme_id' => array(
				...
				'help' => 'По умолчанию, modules/files/views/files.view.id.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате.',
			),
			'view_id' => array(
				'type' => 'none',
				'hide' => true,
