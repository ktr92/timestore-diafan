<?php
/**
 * Редактирование категорий файлового архива
 * 
 * @package    DIAFAN.CMS
 * @author     diafan.ru
 * @version    6.0
...
/**
 * Files_admin_category
 */
class Files_admin_category extends Frame_admin
{
	/**
	 * @var string таблица в базе данных
	 */
	public $table = 'files_category';
	...
	public $variables = array (
		...
		'other_rows' => array (
			...
			'view' => array(
				'type' => 'function',
				'name' => 'Шаблон модуля',
				'help' => 'Шаблон вывода контента модуля на странице списка файлов в категории (веб-мастеру и программисту, не меняйте этот параметр, если не уверены в результате!).',
			),
			'view_rows' => array(
				'type' => 'function',
			...
			'view_element' => array(
				...
				'help' => 'Шаблон вывода контента модуля на странице отдельного файла, вложенного в текущую категорию (веб-мастеру и программисту, не меняйте этот параметр, если не уверены в результате!).',
			),
		),
	);
