...
class Comments_action extends Action
{
	...
	public function add()
	{
		...
		if($this->diafan->configmodules('use_mail', 'comments'))
		{
			...
			$from = $this->diafan->configmodules("emailconf", 'comments') && $this->diafan->configmodules("email", 'comments') ? $this->diafan->configmodules("email", 'comments') : '';
	...
	public function get()
	{
		...
		$attributes = $this->get_attributes($attributes, 'element_id', 'module_name', 'element_type', 'site_id');
