...
class Faq extends Controller
{
	...
	{
		$attributes = $this->get_attributes($attributes, 'count', 'site_id', 'cat_id', 'sort', 'often', 'only_module', 'tag', 'template');
	...
	public function show_block_rel($attributes)
	{
		...
		$attributes = $this->get_attributes($attributes, 'count', 'template', 'only_module');
	...
	{
		$attributes = $this->get_attributes($attributes, 'site_id', 'cat_id', 'template', 'only_module');
