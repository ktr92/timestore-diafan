<?php
/**
 * Редактирование категорий вопросов
 * 
 * @package    DIAFAN.CMS
 * @author     diafan.ru
 * @version    6.0
 ...
 * Faq_admin_category
 */
class Faq_admin_category extends Frame_admin
{
	/**
	...
	public $variables = array (
		...
		'other_rows' => array (
			...
			'view' => array(
				'type' => 'function',
				'name' => 'Шаблон модуля',
				'help' => 'Шаблон вывода контента модуля на странице списка вопросов в категории (веб-мастеру и программисту, не меняйте этот параметр, если не уверены в результате!).',
			),
			'view_rows' => array(
				'type' => 'function',
			...
			'view_element' => array(
				...
				'help' => 'Шаблон вывода контента модуля на странице отдельного вопроса, вложенного в текущую категорию (веб-мастеру и программисту, не меняйте этот параметр, если не уверены в результате!).',
			),
		),
	);
