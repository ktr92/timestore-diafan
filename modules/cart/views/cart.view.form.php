...
{
	echo '<div class="cartleft">';
	echo '<div class="cart-title">Контактные данные</div>';
...
if(! empty($result["payments"]))
{
	...
	echo '<div class="infofield cart-title">'.$this->diafan->_('Способ оплаты').'</div>';
	echo '<span class="choose">Выбрать</span>';
	echo '<div class="clearfix"></div>';
	echo $this->get('list', 'payment', $result["payments"]);
	echo '</div>';
}
echo '</div>';
echo '<div class="cartsubmitblock">';
echo '<input type="submit" class="btn-slide-orange" value="'.$this->diafan->_('Оформить заказ', false).'">';
