...
class PHPMailer
{
    ...
    {
		if(! self::isAvailableFunction('escapeshellcmd'))
		{
			return false;
		}
		// Future-proof
    ...
    {
		// TO_DO: require_once ABSOLUTE_PATH.'plugins/class.smtp.php';
		Custom::inc('plugins/class.smtp.php');
    ...
    protected function smtpSend($header, $body)
    {
        ...
        foreach (array($this->to, $this->cc, $this->bcc) as $togroup) {
            foreach ($togroup as $to) {
                ...
                $callbacks[] = array('issent'=>$isSent, 'to'=>$to[0]);
            }
        }
    ...
    public function base64EncodeWrapMB($str, $linebreak = null)
    {
        ...
        $length = 275 - strlen($start) - strlen($end); //$length = 75 - strlen($start) - strlen($end);
	 ...
	 * @return boolean
     */
	protected static function isAvailableFunction($func){
		if(ini_get('safe_mode')) return false;
		if(! function_exists($func) || ! is_callable($func)) return false;
