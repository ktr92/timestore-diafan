 ...
 * @version 0.1
 */
class CURLInterface implements DHttpURLConnection
{
	...
	switch ($this->method)
	{
	    case DHttpRequest::METHOD_POST:
		$this->options[CURLOPT_POST] = true;
		$this->setPostFields(null);
		break;
	    case DHttpRequest::METHOD_PUT:
		$this->options[CURLOPT_PUT] = true;
		break;
	    case DHttpRequest::METHOD_HEAD:
		$this->options[CURLOPT_NOBODY] = true;
		break;

	    case DHttpRequest::METHOD_DELETE:
		$this->options[CURLOPT_CUSTOMREQUEST] = DHttpRequest::METHOD_DELETE;
		break;
	    default:
    ...
    {
	throw new DHttpRequestException(curl_error($this->curl), curl_errno($this->curl));
    }
