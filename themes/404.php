		...
		<div class="content">
			<div class="container">
				<div class="error-loupe">
					<img src="//www.diafan.ru/img/error404/loupe.png" />
				</div>
				...
				<div class="error-text">
					Проверьте ещё раз адрес страницы и введите<br/>
					его снова, или нажмите кнопку <a href="#" onclick="history.back();return false;">назад</a>, чтобы<br/>
					вернуться на предыдущую и найти там ссылки<br/>
					на нужные данные.
				</div>
